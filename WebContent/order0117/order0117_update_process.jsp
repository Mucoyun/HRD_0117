...
<body>
	...
	<%
		...
		try{
			...
			//5+6-4=7, 5+6-8=3
			atterUnitslnstock = (unitslnstock+getorderQty)-Integer.parseInt(orderQty);
			...
			//order table insert
			sql = "update order0117 set orderQty=?,orderAddress=? where productId=?";
			pstmt = conn.prepareStatement(sql);
